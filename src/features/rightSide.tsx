...
export const RightSide: NextPage = () => {
  return (
    <div className='bg-white rounded-b-xl md:rounded-r-xl md:rounded-l-none w-full md:w-1/2 p-4'>
      <p className='mb-2 text-lg md:text-base text-[#212121]'>2024/9/11 Join, /13 NU, /19 U, 10/7 KU, 11/2 TU</p>
      <p className='mb-2 text-lg md:text-base text-[#212121]'>ゆるーく遊んでます、チルワールド巡ったり、乗り物乗ったり！</p>
      <p className='mb-2 text-lg md:text-base text-[#212121]'>だいたいV睡してます！書き置き来てくれたらうれしー！！</p>
      ...
      <p className='mb-2 text-lg md:text-base text-[#212121]'>本業はWeb系のエンジニアをしています、お仕事お待ちしております(大声)</p>
    </div>
  );
};